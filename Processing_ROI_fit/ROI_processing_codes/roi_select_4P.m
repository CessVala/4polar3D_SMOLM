% =========================================================================
% Function Name: roi_select_4P.m
%
% Description:
%   This function allows interactive ROI (Region of Interest) selection
%   on a 4polar3D dataset and updates the ROI structure accordingly.
%
%   The function:
%     - Lets the user draw an ROI polygon on the input image.
...
%   - Click to draw the ROI polygon and double-click to close it.
%
% Notes:
%   - The input axis handles must be linked to the corresponding parameter maps.
%   - The function is typically called iteratively to select multiple ROIs.
%
% Inputs:
...
function roi_struct = roi_select_4P(roi_struct, ax_i, ax_r, ax_e, ax_d, ax_m)

% Activate the ax_i axis for ROI selection
axes(ax_i)

% Let the user draw a freehand polygon ROI
temp_roi = roipoly;
...
% Optional (commented): could control alpha blending of the mask
